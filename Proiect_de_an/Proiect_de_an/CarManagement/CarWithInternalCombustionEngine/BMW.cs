...
{
    public BMW(int nrOfDoors,
               int nrOfSeats,
               string deliveryType) : base(nrOfDoors,
                                           nrOfSeats,
                                           InternalCombustionEngineCarsPrices.BMW,
                                           deliveryType)
    { }

    public void AddBMWCharacteristicsOnDisplay()
    {
        CharacteristicsOnDisplay.Add("BMW Logo");
        CharacteristicsOnDisplay.Add("Specific BMW Animations");
        CharacteristicsOnDisplay.Add("Specific BMW Functionalities");
    ...
    {
        AddBMWCharacteristicsOnDisplay();
    }
    ...
    public override void BuildCar()
    {
        AnsiConsole.Progress()
            .Start(ctx =>
            {
                ...
                var task2 = ctx.AddTask("[yellow]Sending information to BMW[/]");
