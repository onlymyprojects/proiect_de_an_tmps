...
public class GeneralMotors : Car
{
    public GeneralMotors(int nrOfDoors,
               int nrOfSeats,
               string deliveryType) : base(nrOfDoors,
                                           nrOfSeats,
                                           ElectricEngineCarsPrices.GeneralMotors,
                                           deliveryType)
    { }

    public void AddGeneralMotorsCharacteristicsOnDisplay()
    {
        CharacteristicsOnDisplay.Add("General Motors Logo");
        CharacteristicsOnDisplay.Add("Specific General Motors Animations");
        CharacteristicsOnDisplay.Add("Specific General Motors Functionalities");
    ...
    {
        AddGeneralMotorsCharacteristicsOnDisplay();
    }
    ...
    public override void BuildCar()
    {
        AnsiConsole.Progress()
            .Start(ctx =>
            {
                ...
                var task2 = ctx.AddTask("[yellow]Sending information to General Motors[/]");
