...
public class CarWithInternalCombustionEngineFactory : CarFactory
{
                                      ...
                                      string deliveryType)
    {
        ...
        if (companyType == InternalCombustionEngineCarsCompanies.BMW.ToString())
        {
            car = new BMW(nrOfDoors, nrOfSeats, deliveryType);
        }
        else if (companyType == InternalCombustionEngineCarsCompanies.MERCEDES.ToString())
        {
            car = new Mercedes(nrOfDoors, nrOfSeats, deliveryType);
        }
        else if (companyType == InternalCombustionEngineCarsCompanies.VOLVO.ToString())
        {
            car = new Volvo(nrOfDoors, nrOfSeats, deliveryType);
        }
        else
        {
